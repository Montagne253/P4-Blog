...
<head>
  ...
  <meta name="description"
    content="Jean Forteroche | Écrivain et romancier - Blog - Mon nouveau roman : Un billet simple pour l'Alaska" />
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta http-equiv="X-UA-Compatible" content="ie=edge">
  <link rel="icon" type="image/png" href="public/img/icon0.webp" />
